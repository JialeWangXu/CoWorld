...
export function TagInput({id, htmlfor: htmlFor, label, placeholder, className, maxTag}: inputProps) {
    ...
    return(
        <div className={className}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <div>
                    Has alcanzado el límite de trabajos, elimina uno para añadir otro.
                </div>
              </div>}
            </div>
            ...
            <span> Añadido {tag.length} / {maxTag} trabajos</span>
        </div>
    )
}